<?php
	...
	$baza = new Baza();
	/* definicija upita */
	$upit = "SELECT objava.objava_id, naslov_objave, date_format( datum_objavljivanja_objave,'%d.%m.%Y') as ' datum_objavljivanja_objave', url_slike FROM objava INNER JOIN fotografije_objava ON objava.objava_id = fotografije_objava.objava_id WHERE objava.objava_id BETWEEN 2 AND 4 AND fotografije_objava.fotografija_objava_id % 2 = 1";
